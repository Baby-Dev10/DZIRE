    ...
    <header className="fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-purple-800">
      <div className="container mx-auto px-4 py-3">
        <div className="flex flex-wrap justify-between items-center ">
          <Link
            to="/"
            className="text-2x1 font-bold text-purple-500 items-center space-x-2 flex"
          >
            THE DZIRƎ
          </Link>
          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {user && (
              ...
              >
                ...
                <span className="absolute -top-2 -right-2 bg-purple-500 text-white rounded-full px-2 py-0.5 text-xs group-hover:bg-purple-400 transition duration-300 ease-in-out ">
                  {cart.length}
                </span>
              </Link>
            )}
            ...
            {user ? (
              ...
              <>
                <Link
                  to={"/signup"}
                  className="bg-purple-500 hover:bg-purple-600 text-white py-2 px-4 rounded-md flex items-center transition duration-300 ease-in-out"
                >
